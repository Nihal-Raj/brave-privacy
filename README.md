...
_⚠️ **Warning**: This guide is not necessary to follow, you may use Brave with the default settings (as I do!), this is to implement while needing additional privacy._
